...
describe GrapeV0_14_0::Entity do
  let(:fresh_class) { Class.new(GrapeV0_14_0::Entity) }
  ...
  context 'class methods' do
    ...
    describe '.expose' do
      ...
      context 'with a block' do
        ...
        it 'references an instance of the entity with :using option' do
          module EntitySpec
            ...
            class BogusEntity < GrapeV0_14_0::Entity
              expose :prop1
            end
          end
      ...
      context 'register formatters' do
        ...
        it 'works global on GrapeV0_14_0::Entity' do
          GrapeV0_14_0::Entity.format_with :size_formatter do |_date|
            self.object.class.to_s
          end
          object = {}
      ...
      it 'works global on GrapeV0_14_0::Entity' do
        GrapeV0_14_0::Entity.expose :a
        object = { a: 11, b: 22 }
        expect(GrapeV0_14_0::Entity.represent(object).send(:value_for, :a)).to eq 11
        subject.expose :b
        expect(subject.represent(object).send(:value_for, :a)).to eq 11
        expect(subject.represent(object).send(:value_for, :b)).to eq 22
        GrapeV0_14_0::Entity.unexpose :a
      end
    end
    ...
    describe '.unexpose' do
      ...
      it 'works global on GrapeV0_14_0::Entity' do
        GrapeV0_14_0::Entity.expose :a
        expect(GrapeV0_14_0::Entity.exposures).to eq(a: {})
        GrapeV0_14_0::Entity.unexpose :a
        expect(GrapeV0_14_0::Entity.exposures).to eq({})
      end
    end
    ...
    describe '.represent' do
      ...
      context 'with specified fields' do
        ...
        context 'with strings or symbols passed to only and except' do
          ...
          before do
            user_entity = Class.new(GrapeV0_14_0::Entity)
        ...
        context 'attribute that is an entity itself' do
          it 'returns correctly the children entity attributes' do
            ...
            nephew_entity = Class.new(GrapeV0_14_0::Entity)
  ...
  context 'instance methods' do
    ...
    describe '#serializable_hash' do
      ...
      it "exposes attributes that don't exist on the object only when they are generated by a block with options" do
        module EntitySpec
          class TestEntity < GrapeV0_14_0::Entity
          end
        end
    ...
    describe '#value_for' do
      ...
      context 'child representations' do
        it 'disables root key name for child representations' do
          module EntitySpec
            class FriendEntity < GrapeV0_14_0::Entity
              root 'friends', 'friend'
              expose :name, :email
            end
          end
        ...
        it 'passes through exposed entity with key and value attributes' do
          module EntitySpec
            class CharacteristicsEntity < GrapeV0_14_0::Entity
      ...
      it 'tries instance methods on the entity first' do
        module EntitySpec
          class DelegatingEntity < GrapeV0_14_0::Entity
            root 'friends', 'friend'
            expose :name
            expose :email
      ...
      context 'using' do
        before do
          module EntitySpec
            class UserEntity < GrapeV0_14_0::Entity
              expose :name, :email
            end
          end
        end
    ...
    describe '::DSL' do
      ...
      it 'creates an Entity class when called' do
        ...
        subject.send(:include, GrapeV0_14_0::Entity::DSL)
        expect(subject).to be_const_defined :Entity
      end

      context 'pre-mixed' do
        before { subject.send(:include, GrapeV0_14_0::Entity::DSL) }
